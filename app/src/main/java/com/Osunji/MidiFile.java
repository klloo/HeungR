...
/*
    ...
    @NotNull
    public final List byte2Int(byte[] src) {
        ...
        List dstList = ArraysKt.toList(dst);
        return dstList;
    }

    @NotNull
    public final byte[] int2Byte(@NotNull List srcList) {
        Intrinsics.checkParameterIsNotNull(srcList, "srcList");
        int[] src = CollectionsKt.toIntArray((Collection)srcList);
        int dstLength = src.length;
