...
public class SplashActivity extends AppCompatActivity {
    ...
    private String[] permissionsRequired = new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE , RECORD_AUDIO};
    @Override
    ...
    private void startActivity() {
        ...
        && (ContextCompat.checkSelfPermission(this, RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) ){
            ...
            ActivityCompat.requestPermissions(this, permissionsRequired, PERMISSION_REQUEST_CODE_EXT_STORAGE_);
